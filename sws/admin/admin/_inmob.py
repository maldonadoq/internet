...
print("""
    ...
    <section class="main">
        <div id = "barra">
            <p>Escritorio</p>
            <ul>
                <li><a href="_inmob_form.py">Registre un Inmueble</a></li>
""")

men = ["Multimedias","Enlaces","Paginas","Comentarios","Ventas","Alquiler","Apariencia","Usuarios","Herramientas","Ajustes"];
func.printba(men)
